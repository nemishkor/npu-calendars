...
<h1>
	...
	if(isset($item['id']) && $item['id'])
		echo '<i class="uk-icon-edit"></i> Редагувати інститут';
	else
		echo '<i class="uk-icon-plus"></i> Додати інститут';
	?>
</h1>
<form id="<?php echo strtolower($this->registry['controller_name']); ?>-form" class="uk-form form-validate" action="/<?php echo $this->registry['controller_name']; ?>/edit" method="get" data-uk-margin>
